package cn.imeth.android.image.slider.SliderTypes;
...
public abstract class BaseSliderView {
    ...
    public BaseSliderView options(DisplayImageOptions options) {
        ...
        if(mUrl!=null){
            ...
            if (options == null) {
                builder
                        .cacheInMemory(true)
                        .cacheOnDisk(true)
                        .showImageOnFail(getEmpty())
                        .showImageOnFail(getError());
