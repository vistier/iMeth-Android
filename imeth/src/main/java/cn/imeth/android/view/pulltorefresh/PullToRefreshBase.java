...
import cn.imeth.android.view.pulltorefresh.internal.FlipLoadingLayout;
import cn.imeth.android.view.pulltorefresh.internal.LoadingLayout;
import cn.imeth.android.view.pulltorefresh.internal.RotateLoadingLayout;
import cn.imeth.android.view.pulltorefresh.internal.Utils;
import cn.imeth.android.view.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, PullToRefreshBase.Mode mode, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
