...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link cn.imeth.android.view.swipebacklayout.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link cn.imeth.android.view.swipebacklayout.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
