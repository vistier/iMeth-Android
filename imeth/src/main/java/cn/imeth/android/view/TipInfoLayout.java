...
public class TipInfoLayout extends FrameLayout {
    ...
    private void initView(Context context) {
        ...
        mPbProgressBar = Views.findViewById(view, R.id.pb_loading);
        mTvTipState = Views.findViewById(view, R.id.tv_tip_state);
        mTvTipMsg = Views.findViewById(view, R.id.tv_tip_msg);
        mTipContainer = Views.findViewById(view, R.id.ll_tip);
        setLoading();
        addView(view);
    }
    ...
    public void setLoadError(String errorTip) {
        ...
        TypefaceUtils.setFontAwesome(this.mTvTipState);
