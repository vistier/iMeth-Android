 ...
 *******************************************************************************/
package cn.imeth.android.view.pulltorefresh;
...
import cn.imeth.android.view.pinnedheader.PinnedHeaderListView;
import cn.imeth.android.view.pulltorefresh.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshPinnedHeaderListView extends PullToRefreshAdapterViewBase<PinnedHeaderListView> {
	...
	protected PinnedHeaderListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
			lv = new InternalPinnedHeaderListViewSDK9(context, attrs);
		} else {
			lv = new InternalPinnedHeaderListView(context, attrs);
		}
	...
	class InternalPinnedHeaderListView extends PinnedHeaderListView implements EmptyViewMethodAccessor {
	...
	@TargetApi(9)
	final class InternalPinnedHeaderListViewSDK9 extends InternalPinnedHeaderListView {

		public InternalPinnedHeaderListViewSDK9(Context context, AttributeSet attrs) {
			super(context, attrs);
		}
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshPinnedHeaderListView.this, deltaX, scrollX, deltaY, scrollY,
					isTouchEvent);
