...
public class LogConfigurator {
     ...
     * @param level         Log level for the root logger
     */
    public LogConfigurator(final String fileName, final int maxBackupSize, final long maxFileSize, final String filePattern, final Level level) {
    ...
    public void setLogCatPattern(final String logCatPattern) {
        this.LOG_CAT_PATTERN = logCatPattern;
    }
